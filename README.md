...
This software is based on Random Forest Regression Model and uses the following factors to determine the final score :
  ...
  d.) Scores of batsmen batting currently
  
  e.) Runs scored and wicket fallen in last 5 overs

This software has the record of all the teams and their home grounds such as M Chinnaswamy Stadium, Punjab Cricket Association Stadium, Mohali, Wankhede Stadium and many more.


2.) WORKING OF THE APPLICATION

The working of this application is quite simple. You just have to input the data in the corresponding entry box as has been displayed.
